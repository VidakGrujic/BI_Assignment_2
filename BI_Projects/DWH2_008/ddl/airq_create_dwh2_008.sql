...
-- -------------------------------
DROP TABLE IF EXISTS dwh2_008.ft_param_city_month CASCADE;
DROP TABLE IF EXISTS dwh2_008.dim_alertpeak CASCADE;
DROP TABLE IF EXISTS dwh2_008.dim_param CASCADE;
DROP TABLE IF EXISTS dwh2_008.dim_city CASCADE;
DROP TABLE IF EXISTS dwh2_008.dim_timemonth CASCADE;
